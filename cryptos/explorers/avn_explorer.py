...
def pushtx(tx, coin_symbol="BTC"):
    ...
    response = requests.post(url, {'raw': tx})
...
def block_info(height, coin_symbol="AVN"):
    base_url = get_url(coin_symbol)
...
def current_block_height(coin_symbol="AVN"):
    base_url = get_url(coin_symbol)
